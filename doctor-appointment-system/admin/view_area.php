							...
							<thead>
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<td> <a href="edit_area.php?edc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-edit"></a> <a href="delete_area.php?delc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td> 
							 	</tr> 
						    </tbody> 
						    <?php } ?>
						</table> 
