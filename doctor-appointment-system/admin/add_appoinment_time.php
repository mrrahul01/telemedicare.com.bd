				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4> Add Appoinment Time </h4>
						</div>
						<div class="form-body">
							<form action="" method="post"> 
							<?php if (isset($_REQUEST['submit'])) 
							{
								$appoinment_time = $_REQUEST['appoinment_time'];
								$sql = mysql_query("INSERT INTO apoin_time(appoinment_time)values('".$appoinment_time."')") or die(mysql_error());
								if ($sql) 
								{
									echo "<div class='alert alert-success'> Appoinment Time Added </div>";
								}
								else
								{
								...
								<div class="form-group"> 
									<label for="exampleInputEmail1">Appoinment Time </label>
									 <input type="text" name="appoinment_time" class="form-control" placeholder="Time">
								</div> 
