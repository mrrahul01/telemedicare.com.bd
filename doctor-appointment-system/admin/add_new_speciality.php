				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							{
								$spc = $_REQUEST['speciality'];
								$sql = mysql_query("INSERT INTO speciality(speciality)values('".$spc."')");
								if ($sql) 
								{
									echo "<div class='alert alert-success'>New Speciality Added </div>";
								}
								else
								{
								...
								<div class="form-group"> 
									<label for="exampleInputEmail1">Speciality Name </label>
									 <input type="text" name="speciality" class="form-control" placeholder="Speciality Name">
								</div> 
