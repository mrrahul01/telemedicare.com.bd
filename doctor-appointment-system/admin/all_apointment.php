					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> 
							<thead>
							 ...
							 <?php 
							 	$sql = mysql_query("SELECT cnap.docid,cnap.apntime,cnap.mobile_num,cnap.visiting_doc,cnap.confm_date,nc.doc_name,nc.doc_phone,nc.id FROM confirm_appointment AS cnap JOIN new_doctor AS nc WHERE nc.id=cnap.docid");
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<td> <a href="#.php?edc=<?php  ?>" class="btn btn-xs btn-default glyphicon glyphicon-edit"></a> <a href="delete_apointment.php?delc=<?php 
							$sql1111 = mysql_query("SELECT id FROM confirm_appointment");
							$num111 = mysql_fetch_array($sql1111);
								echo $num111['id'];
								
							?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td> 
							 	</tr> 
						    </tbody> 
						    <?php } ?>
						</table> 
