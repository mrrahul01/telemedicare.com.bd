				...
				<div class="forms">
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4> Edit Country and City</h4>
						</div>
						<div class="form-body">
							<form action="" method="post"> 
								<?php 
								$query = mysql_query("SELECT * FROM area WHERE id='".$_GET['edc']."'");
								...
								if (isset($_REQUEST['submit'])) 
								{
									...
									$city = $_REQUEST['city'];
									$area = $_REQUEST['area'];
									$upsql =mysql_query("UPDATE area SET country='".$country."', city='".$city."', area='".$area."' WHERE id='".$_REQUEST['edc']."'");
									if ($upsql) 
									{
										echo "<div class='alert alert-success'> Area Updated </div>";
