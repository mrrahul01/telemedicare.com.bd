			...
			<div class="header-left">
				...
				<!--logo -->
					...
					<a href="dashboard.php">
						<h1>Telemedicare</h1>
						<span>Doctor Appoinment System</span>
					</a>
				</div>
				<!--//logo-->
			...
			<div class="main-page">
				<div class="tables">
					<div class="table-responsive bs-example widget-shadow">
						<h4 class="title1"> All Promotional Member Details </h4>
						<table class="table table-bordered"> 
							<thead>
							 ...
							 <?php 
							 	$sql = mysql_query("SELECT * FROM promoregistration");
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<td><?php echo $num['paddress']; ?></td>
							 		<td><?php echo $num['registration']; ?></td>
							 		<td><?php echo $num['time1']; ?></td> 
