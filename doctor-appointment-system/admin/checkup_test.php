			...
			<div class="main-page">
				<div class="tables">
					<div class="table-responsive bs-example widget-shadow">
						<h4 class="title1"> All Patient Details </h4>
							...
							<thead>
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<!-- <td><?php echo $num['chkup']; ?></td>  -->
							 		<td><?php echo $num['testdate']; ?></td>
									<td><?php echo $num['testtime']; ?></td>
									
									<td><?php echo $num['hospital']; ?></td> 
									
							 		<td><a href="detail_chkup_info.php?detailsinfo=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-list-alt"></a> / <a href="delete_chkup_info.php?deletedinfo=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td> 
