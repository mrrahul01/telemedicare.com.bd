			...
			<div class="main-page">
				<div class="tables">
					<div class="table-responsive bs-example widget-shadow">
						<h4 class="title1"> View Country </h4>
							...
							<thead>
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<td> <a href="edit_country.php?edc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-edit"></a> <a href="delete_country.php?delc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td> 
							 	</tr> 
						    </tbody> 
						    <?php } ?>
						</table> 
