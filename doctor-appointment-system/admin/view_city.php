			...
			<div class="main-page">
				<div class="tables">
					<div class="table-responsive bs-example widget-shadow">
						<h4 class="title1"> View Country and City </h4>
							...
							<thead>
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<td> <a href="edit_city.php?edc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-edit"></a> <a href="delete_city.php?delc=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td> 
							 	</tr> 
						    </tbody> 
						    <?php } ?>
						</table> 
