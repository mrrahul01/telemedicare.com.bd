					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="" method="post"> 
								<?php 
								$query = mysql_query("SELECT * FROM speciality WHERE id='".$_GET['edspc']."'");
								$result = mysql_fetch_assoc($query);
								if (isset($_REQUEST['submit'])) 
								{
									$speciality = $_REQUEST['speciality'];
									$upsql =mysql_query("UPDATE speciality SET speciality='".$speciality."' WHERE id='".$_REQUEST['edspc']."'");
									if ($upsql) 
									{
										echo "<div class='alert alert-success'> Speciality Updated </div>";
