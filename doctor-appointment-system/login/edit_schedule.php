					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								<li> <a href="doc_logout.php?dclgot=<?php echo $_SESSION['docid']; ?>">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form action="" method="post"> 
								<?php 
								$query = mysql_query("SELECT * FROM apoin_schedule WHERE id='".$_GET['edc']."' && docid='".$_SESSION['docid']."'");
								...
								if (isset($_REQUEST['submit'])) 
								{
									...
									$upsql =mysql_query("UPDATE apoin_schedule SET day='$day', apntime='$apntime', apndate=NOW() WHERE id='".$_REQUEST['edc']."' && docid='".$_SESSION['docid']."'");
									if ($upsql) 
									{
								...
								<!-- <div class="form-group"> 
									<label for="exampleInputEmail1"> Appointment Day </label>
									 <input type="text" name="day" class="form-control" value="<?php echo $result['day']; ?>">
								</div> 
									<div class="form-group"> 
									<label for="exampleInputEmail1"> Appointment Time </label>
									 <input type="text" name="apntime" class="form-control" value="<?php echo $result['apntime']; ?>">
								</div>  -->
