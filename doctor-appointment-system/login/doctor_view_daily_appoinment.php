					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"> 
							<thead>
							 ...
							 <?php 
							 	$sql = mysql_query("SELECT * FROM confirm_appointment WHERE docid='".$_SESSION['docid']."' ORDER BY id DESC");
							 ...
							 <tbody> 
							 	<tr> 
							 		...
							 		<!-- <td> <a href="delete_patient_apoinmnt.php?delp=<?php echo $num['id']; ?>" class="btn btn-xs btn-default glyphicon glyphicon-trash"></a></td>  -->
							 	</tr> 
						    </tbody> 
						    <?php } ?>
						</table> 
