<?php
  ...
  if (isset($_REQUEST['submit'])) 
  {
    ...
    $query = mysql_query("SELECT * FROM new_doctor WHERE doc_phone='$phone'");
    $num = mysql_fetch_array($query);
    $doc_name =  $num['doc_name'];
    $doc_speciality = $num['speciality'];
    $email = $num['email'];
    // $result = mysql_query($query);
    // $num = mysql_fetch_assoc($result) or die(mysql_error());
    // $email = $num['email'];
    // echo $email;
    // $count = mysql_num_rows($result);

    $update_query = mysql_query("UPDATE new_doctor SET password = '$password' WHERE doc_phone ='$phone'" );
...
$bodyContent .= 'new password : ';
$bodyContent .= $password;
$bodyContent .= '<br>Doctor Name : ';
$bodyContent .= $doc_name;
$bodyContent .= '<br>Doctor speciality : ';
$bodyContent .= $doc_speciality;
$bodyContent .= '<br>Phone Number : ';
$bodyContent .= $phone;


$mail->Subject = 'Doctor password is Updated';
