     ...
     <div class="row">
      ...
      <!--       <a href="#" class="navbar-brand">Brand</a> -->
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            ...
            <div class="col-md-4">
                <h4 class="hlcalltext pull-left glyphicon glyphicon-earphone"> 0174-7799494 <span class="spantext">(8AM-10PM) Everyday</span> </h4><br>
<!--                <hr class="hrtop" />-->
            </div>
     </div>
  </section>
...
<div class="main-content">
    <!-- Page Content -->
            ...
            <div class="col-lg-12" style="background-color:#e6e9ed" >
                <img class="img-responsive" src="img/thanknew.jpg" alt="">
            </div>
        </div>
                    ...
                    <!--    <?php include '../sendmail/index.php'; ?>    -->
...
<!-- Footer -->
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
					<center> <p>Copyright &copy; Telemedicare.com.bd</p>  </center> <br>
                </div>
            </div>
        </footer>
<!-- /.container -->
